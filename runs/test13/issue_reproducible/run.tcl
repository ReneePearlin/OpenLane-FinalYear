...
set ::env(CURRENT_NETLIST) "./tmp/placement/7-global.nl.v";
set ::env(CURRENT_ODB) "./tmp/placement/7-global.odb";
set ::env(CURRENT_POWERED_NETLIST) "./tmp/placement/7-global.pnl.v";
...
set ::env(SAVE_LIB) "./results/signoff/picorv32_wrapper.lib";
set ::env(SAVE_NETLIST) "./out.v";
set ::env(SAVE_SDF) "./results/signoff/picorv32_wrapper.sdf";
