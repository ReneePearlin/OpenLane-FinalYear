...
export CURRENT_DEF='./tmp/cts/14-picorv32_wrapper.resized.def';
export CURRENT_NETLIST='./tmp/cts/14-picorv32_wrapper.resized.nl.v';
export CURRENT_ODB='./tmp/cts/14-picorv32_wrapper.resized.odb';
export CURRENT_POWERED_NETLIST='./tmp/cts/14-picorv32_wrapper.resized.pnl.v';
export CURRENT_SDC='./tmp/cts/14-picorv32_wrapper.resized.sdc';
...
export PACKAGED_SCRIPT_7='./tmp/cts/14-picorv32_wrapper.resized.sdc';
export PACKAGED_SCRIPT_8='./tmp/15-picorv32_wrapper.sdc';
...
export SAVE_DEF='./tmp/15-picorv32_wrapper.def';
export SAVE_NETLIST='./out.v';
export SAVE_ODB='./tmp/15-picorv32_wrapper.odb';
export SAVE_POWERED_NETLIST='./tmp/15-picorv32_wrapper.pnl.v';
export SAVE_SDC='./tmp/15-picorv32_wrapper.sdc';
