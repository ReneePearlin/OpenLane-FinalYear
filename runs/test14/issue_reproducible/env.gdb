...
set env CURRENT_DEF ./tmp/cts/14-picorv32_wrapper.resized.def
set env CURRENT_NETLIST ./tmp/cts/14-picorv32_wrapper.resized.nl.v
set env CURRENT_ODB ./tmp/cts/14-picorv32_wrapper.resized.odb
set env CURRENT_POWERED_NETLIST ./tmp/cts/14-picorv32_wrapper.resized.pnl.v
set env CURRENT_SDC ./tmp/cts/14-picorv32_wrapper.resized.sdc
...
set env PACKAGED_SCRIPT_7 ./tmp/cts/14-picorv32_wrapper.resized.sdc
set env PACKAGED_SCRIPT_8 ./tmp/15-picorv32_wrapper.sdc
...
set env SAVE_DEF ./tmp/15-picorv32_wrapper.def
set env SAVE_NETLIST ./out.v
set env SAVE_ODB ./tmp/15-picorv32_wrapper.odb
set env SAVE_POWERED_NETLIST ./tmp/15-picorv32_wrapper.pnl.v
set env SAVE_SDC ./tmp/15-picorv32_wrapper.sdc
